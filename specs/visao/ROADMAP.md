...
| Recursos sem o trecho de documentação registrado na spec de módulo | Desde o ADR 0006 a documentação oficial é o contrato de referência. Sem o trecho no repositório, **a fidelidade da transcrição não é auditável por ninguém** — nem pelo mantenedor daqui a seis meses. 28 dos 30 recursos estão assim | Depende do mantenedor colar o trecho do OpenAPI. É a única mitigação do ADR 0006 |
